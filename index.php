...
<html lang="en">
 <head>
  ...
  <title>DISEASES REPORTING SYSTEM</title>
	...
	<nav class="navbar navbar-expand-lg  py-4" id="navbar">
		<div class="container">
		  <a class="navbar-brand" href="index.html">
		  	Disease<span>Report</span>System
		  </a>
		  ...
		  <div class="collapse navbar-collapse text-center" id="navbarsExample09">
			<ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="Government/admin.php">Government</a>
					
			  </li>
			   <li class="nav-item"><a class="nav-link" href="Hospital/hospital.php">Hospital</a></li>
			<!--   <li class="nav-item"><a class="nav-link" href="Medical Center/medical.php">Medical</a></li>-->
			  
			   <li class="nav-item"><a class="nav-link" href="User/user.php">User</a></li>
			</ul>
		...
		<div class="row">
			<div class="col-lg-9 col-md-10">
				<div class="block">
					...
					<h1 class="animated fadeInUp mb-5">Disease Reporting System.</h1>
